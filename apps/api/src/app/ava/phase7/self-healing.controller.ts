...
/**
 * Canon §28 + §11 / W2 Stream 3 Task 25 — self-healing
 * infrastructure dashboard + recovery actions. Read paths are
 * user-facing (anyone can view service health); admin paths
 * (registering services, defining recovery actions) carry
 * method-level `@RequirePermission('ava:admin')`.
 */
@AuthenticatedOnly()
