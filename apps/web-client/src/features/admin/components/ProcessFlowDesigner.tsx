...
export const ProcessFlowDesigner: React.FC<ProcessFlowDesignerProps> = ({
  steps,
  onStepsChange,
  connections,
  onConnectionsChange,
  ...
  return (
    <div className={`flex h-full ${className}`}>
      ...
      <div
        ref={canvasRef}
        className="flex-1 relative overflow-auto bg-muted [background-image:radial-gradient(circle,hsl(var(--border))_1px,transparent_1px)] [background-size:20px_20px]"
