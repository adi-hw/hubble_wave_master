...
export class GridQueryService {
  ...
  async query<T = unknown>(
    ...
    // Get readable fields
    const allFields = await this.modelRegistry.getProperties(collection, ctx.permissions);
  ...
  async aggregate(
    ...
    const allFields = await this.modelRegistry.getProperties(request.collection, ctx.permissions);
