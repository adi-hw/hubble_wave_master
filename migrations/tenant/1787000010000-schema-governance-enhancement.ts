 ...
 * collection_definition and property_definition tables. It introduces:
 * 
...
export class SchemaGovernanceEnhancement1787000010000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // =========================================================================
    // STEP 2: Enhance collection_definition table
    // =========================================================================
    
    // Add ownership column - determines who can modify this collection
    await queryRunner.query(`
      ALTER TABLE collection_definition 
    ...
    await queryRunner.query(`
      ...
      ON property_definition(owner)
    `);

    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_property_sync_status 
      ON property_definition(sync_status)
    `);

    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS idx_property_collection_owner 
      ON property_definition(collection_id, owner)
    `);

    // Add comments
    await queryRunner.query(`
      COMMENT ON COLUMN property_definition.owner IS 
        'Ownership determines mutability. Custom properties on platform collections must use x_ prefix.'
    `);

    await queryRunner.query(`
      COMMENT ON COLUMN property_definition.custom_property_prefix IS 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // Remove columns from property_definition
    await queryRunner.query(`ALTER TABLE property_definition DROP COLUMN IF EXISTS custom_property_prefix`);
    await queryRunner.query(`ALTER TABLE property_definition DROP COLUMN IF EXISTS platform_version`);
    await queryRunner.query(`ALTER TABLE property_definition DROP COLUMN IF EXISTS is_locked`);
    await queryRunner.query(`ALTER TABLE property_definition DROP COLUMN IF EXISTS sync_error`);
    await queryRunner.query(`ALTER TABLE property_definition DROP COLUMN IF EXISTS sync_status`);
    await queryRunner.query(`ALTER TABLE property_definition DROP COLUMN IF EXISTS owner`);

    // Remove columns from collection_definition
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS platform_version`);
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS is_locked`);
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS physical_checksum`);
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS last_synced_at`);
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS sync_error`);
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS sync_status`);
    await queryRunner.query(`ALTER TABLE collection_definition DROP COLUMN IF EXISTS owner`);
