 ...
 */
@Entity({ name: 'sprint_recordings', schema: 'app_builder' })
@Index(['status'])
@Index(['recordedAt'])
@Index(['recordedBy'])
 ...
 */
@Entity({ name: 'ava_stories', schema: 'app_builder' })
@Index(['recordingId'])
@Index(['status'])
@Index(['priority'])
 ...
 */
@Entity({ name: 'story_implementations', schema: 'app_builder' })
@Index(['storyId'])
 ...
 */
@Entity({ name: 'customization_registry', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'upgrade_impact_analyses', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'upgrade_fixes', schema: 'app_builder' })
@Index(['analysisId'])
 ...
 */
@Entity({ name: 'generated_documentation', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'documentation_versions', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'predictive_insights', schema: 'app_builder' })
@Index(['insightType'])
@Index(['severity'])
@Index(['status'])
@Index(['expiresAt'])
 ...
 */
@Entity({ name: 'insight_analysis_jobs', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'digital_twins', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'sensor_readings', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'self_healing_events', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'service_health_status', schema: 'app_builder' })
@Index(['status'])
 ...
 */
@Entity({ name: 'recovery_actions', schema: 'app_builder' })
@Index(['targetService'])
@Index(['isActive'])
 ...
 */
@Entity({ name: 'ai_reports', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'ai_report_templates', schema: 'app_builder' })
@Index(['category'])
@Index(['isPublic'])
 ...
 */
@Entity({ name: 'nl_queries', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'saved_nl_queries', schema: 'app_builder' })
@Index(['userId'])
 ...
 */
@Entity({ name: 'zero_code_apps', schema: 'app_builder' })
@Index(['isPublished'])
@Index(['createdBy'])
@Index(['category'])
 ...
 */
@Entity({ name: 'zero_code_app_versions', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'app_builder_components', schema: 'app_builder' })
@Index(['category'])
@Index(['componentType'])
 ...
 */
@Entity({ name: 'voice_commands', schema: 'app_builder' })
@Index(['userId', 'createdAt'])
@Index(['sessionId'])
@Index(['intent'])
 ...
 */
@Entity({ name: 'voice_command_patterns', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'user_behaviors', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'predictive_suggestions', schema: 'app_builder' })
 ...
 */
@Entity({ name: 'user_patterns', schema: 'app_builder' })
